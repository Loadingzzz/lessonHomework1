...
public class Main {
    public static void main(String[] args) {
        ...
        */
          ...
          String[] colors = {"aqua","green","orange","violet","yellow","blue","gold"};
    ...
    public static void checkingHero() {
        ...
        Hero emmett = new Hero("Emmett", 50, "pike", heroBag, true);
        ...
        */
        assert "Emmett".equals(emmett.getName()):"Name shoud be Emmet";
        assert 50 == emmett.getArmorStrength():"Armor min must be 50";
        assert "sword".equals(emmett.getWeapon()):"Weapon must be :sword:";
